...
export const QuizQuestion = ({ question, currentQuestionIndex, selectedAnswer, onAnswerChange }: QuizQuestionProps) => {
  return (
    <Card
      bordered={false}
    ...
    >
      ...
      {/* Answer Choices */}
      <Radio.Group onChange={onAnswerChange} value={selectedAnswer} className="w-full">
