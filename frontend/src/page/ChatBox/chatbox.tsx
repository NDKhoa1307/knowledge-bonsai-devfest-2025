  ...
  const handleSendMessage = async () => {
    ...
    if (useMockMode) {
      ...
      try {
        ...
        const response = await sendChatMessage(username, messageText, messages);
        ...
        const aiMessage: Message = {
          ...
          username: "Bonsai Guide",
          content: {
            text: response.data?.metadata?.additionalInfo || "🌱 Knowledge tree generated successfully!",
          },
          timesend: new Date().toISOString(),
          isAI: true,
        };
        ...
        const isNeedMoreInfo = response.data?.metadata?.needMoreInfo || false;
        if (isNeedMoreInfo) {
